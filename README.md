...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r cmak
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r cmak -p
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-cmak
cd docker-cmak
...
| --- | --- | --- | --- |
| cmak | 9001 | Web-GUI Kafka management tool | Y |
## Documentation

[Cmak Administrator Guide](https://support.websoft9.com/docs/cmak)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Cmak Enterprise Support](https://apps.websoft9.com/cmak) 
